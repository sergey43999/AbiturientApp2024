...
public class ProbabilityGeologVolguActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_probability_geolog_volgu);
        ...
        calcProb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (editTextMath.getText().toString().isEmpty() && editTextRussian.getText().toString().isEmpty()){
                    Toast.makeText(ProbabilityGeologVolguActivity.this,"Пожалуйста заполните данные обязательных предметов", Toast.LENGTH_SHORT).show();
                }
                ...
                if (editTextPhysic.getText().toString().isEmpty() && editTextInfo.getText().toString().isEmpty()
                        ...
                        && editTextBio.getText().toString().isEmpty() && editTextGeo.getText().toString().isEmpty()){
                    Toast.makeText(ProbabilityGeologVolguActivity.this,"Пожалуйста заполните хотя бы один из предметов по выбору", Toast.LENGTH_SHORT).show();
                }
                ...
                Integer english=null, physic = null, himia=null, info=null, bio=null, geo=null;
                ...
                if (editTextGeo.getText().toString().isEmpty()){
                    geo = 0;
                } else {
                    geo = Integer.parseInt(editTextGeo.getText().toString());
                }
                ...
                probabilityNew = String.valueOf(math + russian + physic +info+ english+himia+bio+ geo);
    ...
    private void showCheckResDialogVolgu(){
        ...
        View view = LayoutInflater.from(ProbabilityGeologVolguActivity.this).inflate(R.layout.check_probability_pmi, checkVolguConstrLayout);
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(ProbabilityGeologVolguActivity.this);
