...
public class ProbabilityRadioTechActivity extends AppCompatActivity {
        ...
        calcProb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (editTextMath.getText().toString().isEmpty() && editTextRussian.getText().toString().isEmpty()){
                    Toast.makeText(ProbabilityRadioTechActivity.this,"Пожалуйста заполните данные обязательных предметов", Toast.LENGTH_SHORT).show();
                }
                ...
                if (editTextPhysic.getText().toString().isEmpty() && editTextInfo.getText().toString().isEmpty()
                    ...
                    Toast.makeText(ProbabilityRadioTechActivity.this,"Пожалуйста заполните хотя бы один из предметов по выбору", Toast.LENGTH_SHORT).show();
                }
    ...
    private void showCheckResDialogVolgu(){
        ...
        View view = LayoutInflater.from(ProbabilityRadioTechActivity.this).inflate(R.layout.check_probability_pmi, checkVolguConstrLayout);
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(ProbabilityRadioTechActivity.this);
